...
void debug_task(void *pvParameter) {
    while (1) {
        // Debug-Ausgabe alle 3 Sekunden
        printf("Debug-Ausgabe alle 3 Sekunden\n");
        xTaskCreate(debug_task, "debug_task", 4096, NULL, 1, NULL);
        // Verzögerung von 3000 Millisekunden (3 Sekunden)
